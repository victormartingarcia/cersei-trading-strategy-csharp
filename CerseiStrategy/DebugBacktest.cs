...
namespace CerseiStrategy
{
    class DebugBacktest
    {
        static void Main(string[] args)
        {
             ...
             * 
             * Running this project will perform an Ibex 6 month backtest on the Strategy, using 60 min bars.
             * 
            ...
            */
            ...
            CerseiStrategy s = new CerseiStrategy(new Chart(SymbolFactory.GetSymbol("IX"), BarPeriodType.Minute, 60), null);
